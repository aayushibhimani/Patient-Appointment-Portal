...
@section('content')
<<<<<<< HEAD <?php use App\Models\Schedule;
    $schedules = Schedule::where('user_id','=', Auth::user()->id)->get();
    //dd($schedules);
            //
    ?>=======>>>>>>> f1ad51336b07ec67fe789df70f0bfc38ce625e90
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <div class="card schedule-widget mb-0">
                                                                                    ...
                                                                                    <div
                                                                                        class="tab-content schedule-cont">
                                                                                        {{--                                                            @foreach($schedules as $s)--}}
                                                                                        {{--                                                                {{dd($schedule)}}--}}
                                                                                        {{--                                                            @endforeach--}}
                                                                                        {{--                                                            <!-- all slots -->--}}
                                        ...
                                        <div class="modal fade custom-modal" id="add_time_slot">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="{{route('create-schedule-timings')}}"
                                                            method="POST">
                                                            @csrf
                                                            <div class="hours-info">
                                                                <div class="row form-row hours-cont">
                                                                            ...
                                                                            <div class="col-12 col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control"
                                                                                        ...
                                                                                        <option value="10.00 am">10.00
                                                                                            am</option>
                                                                                        <option value="10.30 am">10.30
                                                                                            am</option>
                                                                                        <option value="11.00 am">11.00
                                                                                            am</option>
                                                                                        <option value="11.30 am">11.30
                                                                                            am</option>
                                                                                        <option value="12.00 pm">12.00
                                                                                            pm</option>
                                                                        ...
                                                                        <div class="row form-row">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control">
                                                                                        ...
                                                                                        <option value="12.00 am"
                                                                                            selected>12.00 am</option>
                                                                                        <option value="12.30 am">12.30
                                                                                            am</option>
                                                                                        <option value="1.00 am">1.00 am
                                                                                        </option>
                                                                            ...
                                                                            <div class="col-12 col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control">
                                                                                        <option>-</option>
                                                                                        <option value="12.00 am">12.00
                                                                                            am</option>
                                                                                        <option value="12.30 am"
                                                                                            selected>12.30 am</option>
                                                                                        <option value="1.00 am">1.00 am
                                                                                        </option>
                                                                                        <option value="1.30 am">1.30 am
                                                                                        </option>
