                            ...
                            <div class="card-body">
                                <div class="pro-widget-content">
                                    <div class="profile-info-widget">
                                        <a href="{{asset('./images/uploads/patients/'.$p->profile_pic)}}" class="booking-doc-img">
                                            <img src="{{asset('./images/uploads/patients/'.$p->profile_pic)}}" alt="User Image">
                                        </a>
...
{{--                                                <h5><b>Patient ID :</b> P0016</h5>--}}
                                                <h5 class="mb-0"><i class="fas fa-birthday-cake"></i> {{date('d-m-Y', strtotime($p->dob))}}</h5>
                                                <h5 class="mb-0"><i class="fas fa-map-marker-alt"></i> {{$p->address}}</h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
{{--                                        <li>Gender <span>{{$p->gender}}</span></li>--}}
